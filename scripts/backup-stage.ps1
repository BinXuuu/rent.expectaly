<#
.SYNOPSIS
  将项目安全备份到指定阶段目录，遵循「意料之中～意租」项目的备份规则。

.DESCRIPTION
  - 源目录严格校验为 C:\网站\意料之中-意租
  - 目标根目录严格校验为 D:\网页备份\意料之中-意租
...
$ProjectRoot = "C:\网站\意料之中-意租"
$BackupRoot = "D:\网页备份\意料之中-意租"
...
$expectedProjectRoot = [System.IO.Path]::GetFullPath("C:\网站\意料之中-意租").TrimEnd('\')
...
$expectedBackupRoot = [System.IO.Path]::GetFullPath("D:\网页备份\意料之中-意租").TrimEnd('\')
